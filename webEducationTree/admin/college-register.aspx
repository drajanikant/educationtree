<%@ Page Title="Register College" Language="C#" MasterPageFile="~/admin/admin-master.Master" AutoEventWireup="true" CodeBehind="college-register.aspx.cs" Inherits="webEducationTree.admin.college_register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="server">
    ...
    <div class="col-md-8" style="margin-top: 3%;">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" ID="form1" runat="server">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtCollegeName" runat="server" class="form-control" placeholder="Enter college name" required="required"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="college_state">State :</label>
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdCollegeState" runat="server" class="form-control" placeholder="College State" AutoPostBack="True" OnSelectedIndexChanged="drdCollegeState_SelectedIndexChanged" required="required"></asp:DropDownList>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdDistrict" runat="server" class="form-control" placeholder="College District" AutoPostBack="True" OnSelectedIndexChanged="drdDistrict_SelectedIndexChanged" required="required"></asp:DropDownList>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdTaluka" runat="server" class="form-control" placeholder="College Tauka" AutoPostBack="True" OnSelectedIndexChanged="drdTaluka_SelectedIndexChanged" required="required"></asp:DropDownList>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdCity" runat="server" class="form-control" placeholder="College City" AutoPostBack="True" OnSelectedIndexChanged="drdCity_SelectedIndexChanged" required="required"></asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdCollegeType" runat="server" class="form-control" placeholder="College Type" required="required">
          ...
          <strong>Error!</strong> Error while inserting college name.
        </div>
        <div id="success" runat="server" class="alert alert-success alert-dismissable">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Success</strong><p id="error_message" runat="server"> College name insterted successfully.</p>
        </div>
