<%@ Page Title="Register State" Language="C#" MasterPageFile="~/admin/admin-master.Master" AutoEventWireup="true" CodeBehind="state-register.aspx.cs" Inherits="webEducationTree.admin.state_register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="server">
    ...
    <div class="col-md-8" style="margin-top: 3%;">
            ...
            <div class="panel-body">
                <form class="form-horizontal" ID="form1" runat="server">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtStateName" runat="server" class="form-control" placeholder="Enter State name" required="required"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div id="error" runat="server" class="alert alert-danger alert-dismissable">
          ...
          <strong>Error!</strong><p id="error_message" runat="server"> Error while inserting state name.</p>
        </div>
        <div id="success" runat="server" class="alert alert-success alert-dismissable">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Success</strong> State name insterted successfully.
        </div>
