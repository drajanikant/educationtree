<%@ Page Title="Register City" Language="C#" MasterPageFile="~/admin/admin-master.Master" AutoEventWireup="true" CodeBehind="register-city.aspx.cs" Inherits="webEducationTree.admin.register_city" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="server">
    ...
    <div class="col-md-8" style="margin-top: 3%;">
            ...
            <div class="panel-body">
                <form class="form-horizontal" ID="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdState" runat="server" class="form-control" placeholder="Enter State name" AutoPostBack="True" OnSelectedIndexChanged="drdState_SelectedIndexChanged" required="required"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="district_name">District Name :</label>
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdDistrict" runat="server" class="form-control" placeholder="Enter District name" OnSelectedIndexChanged="drdDistrict_SelectedIndexChanged" AutoPostBack="True" required="required"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="taluka_name">Taluka Name :</label>
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdTaluka" runat="server" class="form-control" placeholder="Enter taluka name" AutoPostBack="True" required="required"></asp:DropDownList>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-3" for="city_name">City Name :</label>
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtCity" runat="server" class="form-control" placeholder="Enter City name" required="required" ></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div id="error" runat="server" class="alert alert-danger alert-dismissable">
          ...
          <strong>Error!</strong> Error while inserting City name.
        </div>
        <div id="success" runat="server" class="alert alert-success alert-dismissable">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Success</strong><p id="error_message" runat="server"> City name insterted successfully.</p>
        </div>
    </div>
