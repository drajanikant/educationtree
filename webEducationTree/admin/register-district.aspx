<%@ Page Title="Register District" Language="C#" MasterPageFile="~/admin/admin-master.Master" AutoEventWireup="true" CodeBehind="register-district.aspx.cs" Inherits="webEducationTree.admin.register_district" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="server">
    ...
    <div class="col-md-8" style="margin-top: 3%;">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <asp:DropDownList ID="drdState" runat="server" class="form-control" placeholder="Enter State name" required="required"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="district_name">District Name :</label>
                        <div class="col-sm-9">
                            <asp:TextBox ID="txtDistrictName" runat="server" class="form-control" placeholder="Enter District name" required="required"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div id="error" runat="server" class="alert alert-danger alert-dismissable">
            ...
            <strong>Error!</strong><p id="error_message" runat="server"> Error while inserting district name</p>.
        </div>
        <div id="success" runat="server" class="alert alert-success alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <strong>Success</strong> District name insterted successfully.
        </div>
